  ...
  const fetchAllNotes=async ()=>{
    ...
    const response = await fetch(`${host}/api/notes/fetchallnotes/`, {
      ...
      headers: {
        ...
        'auth_token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjFkZmQ4MjA4NmUzOWIwNzQ2ODkxZGNhIn0sImlhdCI6MTY0MjMwODMyNH0.VzCVA944Xmz3YJH_NK2-_5oKtVENqDUcpYXtNlLe-5Y'
      }
    });
